...
export class Source {
  ...
  async postCompile() {
    ...
    console.log(this.compiled!.contracts["Compiled_Contracts"]["SoliCode"])
    const { object: bytecode, sourceMap } = this.compiled!.contracts["Compiled_Contracts"]["SoliCode"].evm.deployedBytecode
